...
[![Travis Build](https://travis-ci.org/testmonitor/laravel-nested-migrations.svg?branch=master)](https://travis-ci.org/testmonitor/laravel-nested-migrations)
...
```php
TestMonitor\NestedMigrations\MigrationServiceProvider::class
```
